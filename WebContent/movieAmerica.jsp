...
<%
                ...
                ResultSet rs = null;  
                String sql = "SELECT * FROM movie where country='美国';";  //查询语句
     ...
     <div class="div5">
            <ul style="display:flex;flex-direction:coloumn;align-items:center;flex-wrap:wrap;margin-left:20px;margin-right:100px;">
