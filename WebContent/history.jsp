		...
		<div class="MyOwnPage">
			...
			<div class="MyOwnPageCenter">
				...
				<div class="operatePage">
					<div class="history"><c:forEach
							items="${sessionScope.history }" var="item" varStatus="s">
							<div
								style="width: 100%; display: flex; flex-direction: row; justify-content: flex-start; line-height: 30px;">
								<div style="font-size: 13px;"><span
									style="color: gray; font-size: 13px;">电影名字：</span>${ item[2]}</div>
								<div style="margin-left: 20px; font-size: 13px;"><span
									style="color: gray; font-size: 13px;"> 访问时间:</span>${ item[1]}
							</div>
								<div style="margin-left: 20px; font-size: 13px;"><span
									style="color: gray; font-size: 13px;"> 访问者:</span>${ item[0]}</div>
								<div style="margin-left: 20px; font-size: 13px;"><span
									style="color: gray; font-size: 13px;"> 操作类型：${item[3] }电影</span>
							</div>
							</div>
						</c:forEach></div>
			</div>
