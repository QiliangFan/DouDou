...
<%
                ...
                ResultSet rs = null;  
                String sql = "SELECT * FROM movie;";  //查询语句
     ...
     <div class="div5">
            <ul>
                <li><a href="javascript:void(0)" onclick="convey(this,'${sessionScope.email}')" name=<%=mname %>><img  style="padding-left:40px;padding-top:5px;" src=<%=addre %> alt="<%=mname %>" ></a></li>
            </ul>
        </div>
    <br>
    <div class="div6">
