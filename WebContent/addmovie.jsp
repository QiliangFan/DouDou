...
<p style="font-size:25px; color:#666; margin-left:20px;">Movie</p><hr/>
    ...
    上映日期:<input type="text" name="time"><br>
    制片国家：<input type="text" name="country"><br>
    电影编剧：<input type="text" name="screenwriter"><br>
    电影类型：<input type="text" name="moviekind"><br>
    获评总分：<input type="text" name="grade"><br>
    评分人数：<input type="text" name="numOfPeople"><br>
    电影票价：<input type="text" name="price"><br>
    电影主演：<input type="text" name="actor"><br>
