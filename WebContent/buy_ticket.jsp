...
<body>
    ...
    <div class="div4">
        ...
        padding-top:30px;
        padding-left:100px;
        color:rgb(0, 0, 0);">电影票 - 天津</p>
        <br />
        <a href=""><img style="padding-left:100px;padding-top:0px;width:650px;%;" src="img/guanggao.jpeg" alt="蜘蛛侠： 英雄远征 2019"></a>
        <br />
        <p style="font-size:15px;
        font-family:Arial;
        padding-top:10px;
        padding-left:100px;
        color:rgb(48, 116, 86);">正在上映</p>
    </div>
<%  
        try {  
...
<%
				...
				//out.print("<br/>");
				%>
				<div style="display:flex;flex-direction:row;align-items:center;flex-wrap:wrap;margin-right:100px;">
				<%
                while (rs.next()) {
                	...
                	//out.print(tmp);
                 	...
                 	//out.print(addre);
                %>
                <div style="display:flex;flex-direction:column;align-items:center;margin-top: 50px;margin-left: 50px;">
     <div class="div5">
    ...
    <div class="div6">
            <ul style="display:flex;flex-direction:column;align-items:center;">
                <li style="text-align:center; margin-top:5px;"><a  href="" title="<%=mname %>"><%=mname %></a></li>
            </ul>
    </div>
    <div >
                <ul style="display:flex;flex-direction:column;align-items:center;">
                    <li style="list-style:none;text-align:center;"><a  href="javascript:void(0)" onclick="addToCart('${sessionScope.email}','<%=mname %>')" class="button button1" style="font-size:13px;margin-top:5px; background-color:#268DCD; 
    color: white;">购票</a></li>
                </ul>
            </div>
    </div>
