...
<div style="display:flex;flex-direction:row;width:100%;align-items:center;justify-content:center;margin-top:40px;">
	...
	<div>
		<form action="DeleteMyServlet" method="post">
			<input type="text" name="movieNameFromTable" value="${item[4]}" style="display:none;"/>
			<input type="text" name="filmtext" value="${item[0] }" style="display:none;"/>
			<input type="submit" class="sub" value="删除"/>
		</form>
	</div>
</div>
</c:forEach>
